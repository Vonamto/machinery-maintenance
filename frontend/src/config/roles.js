...
export const PAGE_PERMISSIONS = {
  ...
  CHECKLIST_HISTORY: [ROLES.SUPERVISOR, ROLES.MECHANIC, ROLES.DRIVER, ROLES.ADMIN, ROLES.GUEST, ROLES.MANAGER],  // ✅ Added MECHANIC
  ...
  SUIVI: [ROLES.SUPERVISOR, ROLES.MECHANIC, ROLES.DRIVER, ROLES.ADMIN, ROLES.GUEST, ROLES.MANAGER],  // 🆕 NEW: Menu/Index page permission
  SUIVILIST: [ROLES.SUPERVISOR, ROLES.MECHANIC, ROLES.DRIVER, ROLES.ADMIN, ROLES.GUEST, ROLES.MANAGER],
  SUIVIMANAGE: [ROLES.SUPERVISOR, ROLES.MECHANIC, ROLES.ADMIN],  // ✅ Added MECHANIC
