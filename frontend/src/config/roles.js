...
export const PAGE_PERMISSIONS = {
  ...
  SUIVI_LIST: [ROLES.SUPERVISOR, ROLES.MECHANIC, ROLES.DRIVER, ROLES.ADMIN, ROLES.GUEST, ROLES.MANAGER],
  SUIVI_MANAGE: [ROLES.SUPERVISOR, ROLES.ADMIN, ROLES.GUEST],
  SUIVI_DETAIL: [ROLES.SUPERVISOR, ROLES.MECHANIC, ROLES.DRIVER, ROLES.ADMIN, ROLES.GUEST, ROLES.MANAGER],
