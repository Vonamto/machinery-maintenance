...
export const PAGE_PERMISSIONS = {
  // Checklist
  CHECKLIST:         [ROLES.SUPERVISOR, ROLES.DRIVER, ROLES.ADMIN, ROLES.MANAGER, ROLES.SUP_LOG, ROLES.GUEST],
  CHECKLIST_FORM:    [ROLES.SUPERVISOR, ROLES.DRIVER, ROLES.ADMIN, ROLES.SUP_LOG],
  CHECKLIST_HISTORY: [ROLES.SUPERVISOR, ROLES.DRIVER, ROLES.ADMIN, ROLES.GUEST, ROLES.MANAGER, ROLES.SUP_LOG, ROLES.GUEST],
