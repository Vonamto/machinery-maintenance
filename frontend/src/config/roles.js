...
export const PAGE_PERMISSIONS = {
  // Checklist
  CHECKLIST: [ROLES.SUPERVISOR, ROLES.DRIVER, ROLES.ADMIN, ROLES.GUEST, ROLES.MANAGER],
  CHECKLIST_FORM: [ROLES.SUPERVISOR, ROLES.DRIVER, ROLES.ADMIN, ROLES.GUEST],
  CHECKLIST_HISTORY: [ROLES.SUPERVISOR, ROLES.DRIVER, ROLES.ADMIN, ROLES.GUEST, ROLES.MANAGER], 
  ...
  // Cleaning
  CLEANING: [ROLES.SUPERVISOR, ROLES.MECHANIC, ROLES.DRIVER, ROLES.CLEANER, ROLES.ADMIN, ROLES.GUEST, ROLES.MANAGER],
  CLEANING_FORM: [ROLES.SUPERVISOR, ROLES.CLEANER, ROLES.ADMIN, ROLES.GUEST],
  ...
  SUIVI: [ROLES.SUPERVISOR, ROLES.DRIVER, ROLES.ADMIN, ROLES.GUEST, ROLES.MANAGER],  // 🆕 NEW: Menu/Index page permission
  SUIVILIST: [ROLES.SUPERVISOR, ROLES.DRIVER, ROLES.ADMIN, ROLES.GUEST, ROLES.MANAGER],
  SUIVIMANAGE: [ROLES.SUPERVISOR, ROLES.ADMIN],
  SUIVIDETAIL: [ROLES.SUPERVISOR, ROLES.DRIVER, ROLES.ADMIN, ROLES.GUEST, ROLES.MANAGER],
