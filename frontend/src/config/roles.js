...
export const PAGE_PERMISSIONS = {
  // Checklist
  CHECKLIST: [ROLES.SUPERVISOR, ROLES.DRIVER],
  CHECKLIST_FORM: [ROLES.SUPERVISOR, ROLES.DRIVER],
  CHECKLIST_HISTORY: [ROLES.SUPERVISOR, ROLES.DRIVER],
  ...
  // Equipment
  EQUIPMENT: [ROLES.SUPERVISOR, ROLES.MECHANIC, ROLES.DRIVER],
  EQUIPMENT_LIST: [ROLES.SUPERVISOR, ROLES.MECHANIC, ROLES.DRIVER],
  EQUIPMENT_MANAGE: [ROLES.SUPERVISOR],
