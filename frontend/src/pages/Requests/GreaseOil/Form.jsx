    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-slate-900 to-black text-white">
      ...
      <div className="max-w-4xl mx-auto p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          {/* Fields for model/plate/driver/etc. remain unchanged */}
          {/* ... */}

          {/* Odometer Photo - Before Upload */}
          <div className="group">
            <label className="block text-sm font-medium text-gray-300 mb-3">
              Odometer Photo - Before (Optional)
            </label>
            <div className="flex gap-3">
              <label className="flex-1 flex items-center justify-center gap-2 cursor-pointer bg-gradient-to-r from-amber-600 to-amber-700 hover:from-amber-700 hover:to-amber-800 text-white px-4 py-3 rounded-xl transition-all shadow-lg shadow-amber-500/30 hover:shadow-amber-500/50">
                <Upload size={18} />
              ...
              <label className="flex-1 flex items-center justify-center gap-2 cursor-pointer bg-gradient-to-r from-orange-600 to-orange-700 hover:from-orange-700 hover:to-orange-800 text-white px-4 py-3 rounded-xl transition-all shadow-lg shadow-orange-500/30 hover:shadow-orange-500/50">
                <Camera size={18} />
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full py-4 rounded-xl bg-gradient-to-r from-amber-600 to-orange-500 hover:from-amber-700 hover:to-orange-600 text-white font-semibold text-lg shadow-lg shadow-amber-500/50 hover:shadow-amber-500/70 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          >
